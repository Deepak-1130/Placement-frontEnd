...
const filterCompaniesFinal=filteredCompanies.filter((company)=>{
  ...
  return (
    <section id="companies" className="lp-companies lp-companies--fullwidth">
      <div className="lp-companies__header">
       
        <h2 className="lp-section-heading">Our Recruiters</h2>
      </div>
      ...
      {!loading && !error && companies.length === 0 && (
        <div className="lp-state lp-state--empty">
          ...
          <p className="lp-state__desc">
            No companies meet the selected criteria at this time.
          </p>
          <button
